...
hel = tkFont.Font(size=20, weight='bold')
for x in range(6):
    for y in range(4):
        button=Button(command= lambda x=x,y=y: show_symbol(x,y),width=10,height=5,bg='#03fc7f',fg='#222624',borderwidth="2px",highlightcolor="white")
        button['font'] = hel
